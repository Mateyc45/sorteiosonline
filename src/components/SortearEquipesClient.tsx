          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                {id ? "Resultado: Equipes Formadas" : "Sorteador de Times e Equipes Online"}
              </h1>
              <p className="mt-1 text-gray-500 font-medium">
                  {id ? 'Confira a divisão dos times abaixo.' : 'Divida grupos e tire times de forma justa, rápida e 100% grátis.'}
              </p>
            </div>
          </div>
